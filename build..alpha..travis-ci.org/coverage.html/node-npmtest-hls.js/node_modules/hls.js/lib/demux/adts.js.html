...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-hls.js/node_modules/hls.js/lib/demux/adts.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-hls.js/node_modules/hls.js/lib/demux/adts.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-hls.js/node_modules/hls.js/lib/demux/</a> &#187; adts.js</div>
</div>
<div class="body">
 ...
 */
var ADTS = {
  getAudioConfig: <span class="fstat-no" title="function not covered" >function getAudioConfig(observer, data, offset, audioCodec) {</span>
<span class="cstat-no" title="statement not covered" >    var adtsObjectType,</span>
        // :int
    adtsSampleingIndex,
        // :int
...
<span class="cstat-no" title="statement not covered" >      observer.trigger(Event.ERROR, { type: _errors.ErrorTypes.MEDIA_ERROR, details: _errors.ErrorDetails.FRAG_PARSING_ERROR, fatal: true, reason: 'invalid ADTS sampling index:' + adtsSampleingIndex });</span>
...
<span class="cstat-no" title="statement not covered" >    _logger.logger.log('manifest codec:' + audioCodec + ',ADTS data:type:' + adtsObjectType + ',sampleingIndex:' + adtsSampleingIndex + '[' + adtsSampleingRates[adtsSampleingIndex] + 'Hz],channelConfig:' + adtsChanelConfig);</span>
...
<span class="cstat-no" title="statement not covered" >      if (audioCodec &amp;&amp; (audioCodec.indexOf('mp4a.40.29') !== -1 || audioCodec.indexOf('mp4a.40.5') !== -1) || !audioCodec &amp;&amp; adtsSampleingIndex &gt;= 6) {</span>
        // HE-AAC uses SBR (Spectral Band Replication) , high frequencies are constructed from low frequencies
        // there is a factor 2 between frame sample rate and output sample rate
        // multiply frequency by 2 (see table below, equivalent to substract 3)
<span class="cstat-no" title="statement not covered" >        adtsExtensionSampleingIndex = adtsSampleingIndex - 3;</span>
...
<span class="cstat-no" title="statement not covered" >        if (audioCodec &amp;&amp; audioCodec.indexOf('mp4a.40.2') !== -1 &amp;&amp; adtsSampleingIndex &gt;= 6 &amp;&amp; adtsChanelConfig === 1 || !audioCodec &amp;&amp; adtsChanelConfig === 1) {</span>
<span class="cstat-no" title="statement not covered" >          adtsObjectType = 2;</span>
<span class="cstat-no" title="statement not covered" >          config = new Array(2);</span>
        }
<span class="cstat-no" title="statement not covered" >        adtsExtensionSampleingIndex = adtsSampleingIndex;</span>
